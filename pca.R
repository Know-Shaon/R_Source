...
library('ggplot2')
setwd('C:/Users/kishore.thadiboyina/OneDrive/R Source')
# First code snippet
prices <- read.csv('https://raw.githubusercontent.com/johnmyleswhite/ML_for_Hackers/master/08-PCA/data/stock_prices.csv')
...
date.stock.matrix <- cast(prices, Date ~ Stock, value = 'Close')   #pivte
...
my_pca <- prcomp(date.stock.matrix[, 2:ncol(date.stock.matrix)], center = TRUE, scale = TRUE) 
biplot(my_pca)
...
dji.prices <- read.csv('https://raw.githubusercontent.com/johnmyleswhite/ML_for_Hackers/master/08-PCA/data/DJI.csv')
